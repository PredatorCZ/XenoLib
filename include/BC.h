...
{
	static const int TYPE = CompileFourCC("SKEL");
...
{
	static const int TYPE = CompileFourCC("ANIM");
...
class BC
{
	static const int ID = CompileFourCC("BC\0\0");
...
public:
	...
	template<class C> ES_FORCEINLINE C *GetClass()
	{
